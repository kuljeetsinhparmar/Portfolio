...
export const personal = {
  ...
  location: 'Pune, India',
  email: 'kuljeetsinh@gmail.com',       // ← your Gmail here
  github: 'https://github.com/kuljeetsinhparmar',    // ← your GitHub URL
  linkedin: 'https://www.linkedin.com/in/kuljeetsinh-parmar/', // ← your LinkedIn
  resumeUrl: '/resume.pdf',             // ← drop resume.pdf in /public folder
  bio: [
...
export const stats = [
  { value: '',   label: 'Project Shipped'   },
  { value: '4+',  label: 'Technologies'      },
  { value: 'CE',  label: 'Graduate 2025'     },
...
export const projects = [
  {
    ...
    github: 'https://github.com/kuljeetsinh/inventory-management', // ← update
    demo: '',   // ← add live link if deployed, else leave empty
    honest:
