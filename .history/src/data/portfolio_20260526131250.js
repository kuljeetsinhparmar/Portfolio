...
export const stats = [
  ...
  { value: 'Internship',  label: 'SAC,ISRO'  },
...
export const skills = [
  ...
  },
  {
    category: 'Coursework',
    color: 'green',
    items: ['Data Structures & Algorithms', 'DBMS', 'CN', 'OS',],
  },
  {
...
export const projects = [
  {
    ...
    demo: 'https://inventory-management-gray-xi.vercel.app',  
    honest:
  ...
  tagline: 'A responsive portfolio website to showcase my projects and skills.',
  description:
    'Designed and developed a modern personal portfolio website to showcase my projects, technical skills, experience, and software engineering journey. Focused on clean UI, responsiveness, and smooth user experience.',
  features: [
...
export const journey = [
  ...
  desc: "Built and deployed a personal portfolio website focused on performance, responsive design, and showcasing full-stack development projects."
},
  {
    date: '2024–2025',
